---
slug: introducing-tailwind-nextjs
...
tags:
  ...
  - license
  - mdx
summary: Looking for a performant, out of the box template, with all the best in
  web technology to support your blogging needs? Checkout the Tailwind Nextjs
